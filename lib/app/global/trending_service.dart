...
class TrendingSection extends StatefulWidget {
  ...
  final List<VenueResponse?> projects;
                              ...
                              InkWell(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 24.0),
                                    Text(
                                      widget.projects[index]!.location,
                                      style: GoogleFonts.roboto(
                                        fontSize: 14.0,
                                        color: Colors.black54,
                                      ),
                                    ...
                                    SizedBox(
                                      height: 70.0,
                                      child: Text(
                                        widget.projects[index]!.venueName,
                                        style: GoogleFonts.roboto(
                                          fontSize: 16.0,
                                          color: Colors.black87,
                                        ),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      '${widget.projects[index]!.pricePerHour} ${widget.projects[index]!.rating}',
                                      style: GoogleFonts.roboto(
                                        color: Colors.black54,
                                        fontSize: 14.0,
                                      ),
